...
def main():
    print ('len(alphabets)',len('0123456789'))
    max_str_len = 10 # max length of input labels
    num_of_characters = len('0123456789') + 1 # +1 for ctc pseudo blank
    num_of_timestamps = 31  # max length of predicted labels

    digit_model, digit_model_CTC = build_digit_model(alphabets = '0123456789', max_str_len = max_str_len)
    digit_model.summary()
